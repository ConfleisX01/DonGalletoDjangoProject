...
from inventarios.views import inventarioProductoView, inventrioMateriaView, RegistrarMermaView, ListaMermaView
...
urlpatterns = [
    ...
    path('mermas/', ListaMermaView.as_view(), name='lista_mermas'),
]