...
from ventas_app.views import ListaProductosView, DetallesProductoView,VentaCreateView,dashboard_view,DashboardVentasView,DashboardPresentacionesView, DashboardPresentacionesView,  ListaVentasView 
