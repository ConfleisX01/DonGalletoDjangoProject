...
from ventas_app.views import VerListaPedidosClientesView, DetallesPedidoClienteView, VentaPosView
...
urlpatterns = [
    ...
    path('cerrar_venta/<int:carrito_id>', VentaPosView.as_view(), name='cerrar_venta')
]